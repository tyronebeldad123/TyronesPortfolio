  ...
  function App() {
    ...
    // Initialize EmailJS
    useEffect(() => {
      // You'll need to get these values from EmailJS dashboard
      // For now, I'll use placeholders
      emailjs.init("Z08TgNZPUWVSqV1BL"); // Replace with your actual public key
    }, []);
    ...
    const handleFormSubmit = async (e) => {
      ...
      try {
        ...
        const templateParams = {
          to_name: 'Tyrone Clint Beldad',
          from_name: formData.name,
          from_email: formData.email,
          subject: formData.subject || 'OJT Opportunity Inquiry',
          message: formData.message,
          reply_to: formData.email,
          to_email: 'tyroneclint.beldad@cit.edu'
        };

        // Send email using EmailJS
        // Replace these with your actual EmailJS credentials:
        // 1. YOUR_SERVICE_ID - From EmailJS Dashboard > Email Services
        // 2. YOUR_TEMPLATE_ID - From EmailJS Dashboard > Email Templates
        // 3. YOUR_PUBLIC_KEY - From EmailJS Dashboard > Account > API Keys
        const response = await emailjs.send(
          'service_28oguq6',        // Replace with your service ID
          'template_r65b9ux',       // Replace with your template ID
          templateParams,
          'Z08TgNZPUWVSqV1BL'         // Replace with your public key
        );
